...
from .python.word2vec_NormalizationTrain import testNormalization
...
def output(request):
	if request.method == 'POST':
		...
		form = TextForm()
	hasil = testNormalization(request.POST['your-text'])
...
def index(request):
	template = loader.get_template('normalization/index.html')
